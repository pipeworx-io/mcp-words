...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/find_synonyms \
  -H 'Content-Type: application/json' \
  -d '{"word":"happy"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/find_synonyms`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
